    ...
    <div class="login_container">
        ...
        <div class="content_registry">
            <div class="registration_form">
                ...
                <input type="text" name="name" placeholder="Nombre" class="user_info">
                ...
                <input type="email" name="email" placeholder="Email" class="user_info"">
                <legend>Celular</legend>
                <input type=" text" name="phone_number" placeholder="Numero Celular" class="user_info">
                <legend>Contraseña</legend>
                <input type="password" name="password" placeholder="Contraseña" class="user_info">
